# Acceptance Report: JOB-CONVEYOR-CLAMP_FAIL
...
- `000.0s` **job** [pass] Started autonomous assembly for JOB-CONVEYOR-CLAMP_FAIL
...
- `040.8s` **fixture** [fail] Clamp command did not reach closed sensor before timeout
- `041.6s` **recovery** [recovered] Fixture clamp failed; cycling clamp and rechecking part presence
