# Acceptance Report: JOB-CONVEYOR-BELT_SLIP
...
- `000.0s` **job** [pass] Started autonomous assembly for JOB-CONVEYOR-BELT_SLIP
...
- `026.4s` **execution** [fail] Belt placed but visual verification detected slip
- `027.2s` **recovery** [recovered] Belt slip detected; backing out, re-tensioning, and retrying seating
